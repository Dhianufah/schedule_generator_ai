...
class ScheduleResultCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final lines = schedule
        .split('\n') // biar enter
        .map((line) => line.trim()) // biar ga overlot
        .where((line) => line.isNotEmpty) // nyari wadah yang udh keisi makan nya naro (isnotempty)
        .toList(); // biar ga mismatch
                        ...
                        children: [
                          ...
                          Expanded(
                            child: SelectableText(
                              line.substring(2),
                              //  substring method adalah mengembalikan bagian string berdasarkan index awal dan akhir yang di tentukan
